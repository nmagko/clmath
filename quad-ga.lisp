...
;;; Integration to clmath: Victor C Salas, May 9, 2024
...
(defun int_gs_l1(fun n) 
  (let* ((abscissae (improvedroots (setroots n) n)) ;; the points to evaluate fun at.
	 (np1 (+ n 1))
	 (weights (map 'vector #'(lambda(r)(legendre_pdwt np1 r))
		       abscissae)))
    ;; compute the sum.
...
#|
;; :pa :ga
(clmath:int_gs_l1 #'exp 10) ; 10 points
(clmath:int_gs_l1 #'exp 20) ; 20 points
(clmath:int_gs_l1 #'exp 40)
