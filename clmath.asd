...
(defsystem clmath
    ...
    :components ((:file "defpackage")
                 ...
                 (:file "quad-ga" :depends-on ("defpackage"))
                 (:file "gnuplot" :depends-on ("defpackage"))
                 (:file "lwm" :depends-on ("defpackage"))
                 (:file "ltstats" :depends-on ("defpackage"))
                 (:file "gauss" :depends-on ("defpackage"))
